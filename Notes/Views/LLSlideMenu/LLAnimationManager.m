...
- (void)startAnimate{
    ...
    if (_layer.distance >= _layer.bgWidth) {
        ...
        CAKeyframeAnimation *animaBase = [self createBaseAnima:@"distance" duration:.1f fromValue:@(_layer.distance) toValue:@(_layer.bgWidth)];
...
- (void)endAnimate{
    ...
    if (_layer.distance >= _layer.bgWidth) {
        ...
        CAKeyframeAnimation *animSpring = [self createSpringAnima:@"distance" duration:0.5f
                                           usingSpringWithDamping:0.5 initialSpringVelocity:3 fromValue:@(_layer.distance) toValue:@(0)];
